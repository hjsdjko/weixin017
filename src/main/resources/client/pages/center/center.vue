	...
	<view class="content">
		<view :style='{"width":"100%","padding":"0px 0 120rpx","position":"relative","background":"#f4f4f4","height":"auto"}'>
			...
			<view :style='{"padding":"0px 0px 40rpx 0px","margin":"40rpx 20rpx 120rpx 20rpx","borderRadius":"8rpx","flexWrap":"wrap","background":"none","display":"flex","width":"calc(100% - 40rpx)","height":"auto"}' class="list">
				...
				<view v-if="user&&user.id" @tap="onPageTap2('../shop-recharge/pay-confirm')" :style='{"border":"0px solid #6fcbcb60","padding":"0 20rpx 0 0","margin":"0 20rpx 20rpx 0","borderColor":"#3da74250","alignItems":"center","textAlign":"center","display":"flex","transition":"all 0s","borderRadius":"0px","flexWrap":"wrap","background":"#ffffff","borderWidth":"2rpx","width":"calc(33% - 20rpx)","position":"relative","borderStyle":"solid","height":"92rpx"}' class="li" hover-class="hover">
					<view v-if="false" :style='{"width":"48rpx","fontSize":"48rpx","color":"#2f72e3","display":"inline-block"}' class="iconfont icon-chongzhi4"></view>
					<view class="text" :style='{"padding":"0 10rpx 0 10rpx","margin":"0 0 0 0","color":"#333333","display":"inline-block","width":"auto","lineHeight":"48rpx","fontSize":"26rpx"}'>用户充值</view>
					<view v-if="true" :style='{"color":"#999999","top":"32rpx","width":"28rpx","lineHeight":"28rpx","fontSize":"28rpx","position":"absolute","right":"10rpx"}' class="iconfont icon-gengduo2"></view>
				</view>
